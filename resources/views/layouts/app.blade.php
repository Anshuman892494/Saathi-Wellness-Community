...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'A supportive online community focused on health, wellness, fitness, and mental well-being.')">
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                ...
                <p class="text-muted small">A community built on compassion, support, and the shared journey toward health and wellness.</p>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-4">
                ...
                <div class="wellness-tip-card">
                    <p class="mb-0 small">"Take care of your body. It's the only place you have to live." — Jim Rohn</p>
                </div>
            </div>
        </div>
        <hr class="footer-divider">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <p class="text-muted small mb-0">© {{ date('Y') }} Saathi Wellness Community. Built with 💚</p>
